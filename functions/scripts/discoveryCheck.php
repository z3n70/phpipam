...
if ($Scan->icmp_type == "fping") {
    ...
    print "discoveryCheck scanning " . sizeof($scan_subnets) . " subnets\n";
    ...
    //ping, pear
    print "discoveryCheck scanning " . sizeof($addresses) . " IPs\n";
...
# update scan time
print "discoveryCheck found $discovered new hosts\n";
